...
extern Gia_Man_t *         Gia_AigerReadFromMemoryChoice( char * pContents, int nFileSize, int fGiaSimple, int fSkipStrash, int fCheck, Vec_Int_t * aig_orders,Vec_Int_t * len);
extern Gia_Man_t *         Gia_AigerRead( char * pFileName, int fGiaSimple, int fSkipStrash, int fCheck );
extern Gia_Man_t *         Gia_AigerReadchoice( char * pFileName, int fGiaSimple, int fSkipStrash, int fCheck,Vec_Int_t * vVec1,Vec_Int_t * vVec2 );
extern void                Gia_PrintReprs(Gia_Rpr_t *pReprs, int nObjs);
extern void                Gia_PrintNexts(int *pNexts, int nObjs); 
...
extern void                Gia_ManCollectAndsCis_rec( Gia_Man_t * p, int iObj, Vec_Int_t * vAnds, Vec_Int_t * vCis );
extern void                Gia_ManCollectAnds( Gia_Man_t * p, int * pNodes, int nNodes, Vec_Int_t * vNodes, Vec_Int_t * vLeaves );
extern void                Gia_ManCollectAndsCis( Gia_Man_t * p, int * pNodes, int nNodes, Vec_Int_t * vAnds, Vec_Int_t * vCis );
