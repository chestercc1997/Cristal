...
extern ABC_DLL Vec_Ptr_t *        Abc_AigCollectDangles(Abc_Aig_t* pMan); 
...
extern ABC_DLL Vec_Int_t *        Abc_NtkCollectCriticalNodeIds( Abc_Ntk_t * pNtk ) ;
extern ABC_DLL Vec_Int_t *        Abc_NtkCollectSampledNodeIds(Abc_Ntk_t * pNtk, int K);
/*=== abcCheck.c ==========================================================*/
...
extern ABC_DLL int                Abc_NtkAigStore( Abc_Ntk_t * pNtk );
...
extern ABC_DLL void               Abc_NtkAigStoreClean();
/*=== abcFunc.c ==========================================================*/
...
extern ABC_DLL Abc_Ntk_t *        Abc_NtkCreateMffc_cone( Abc_Ntk_t * pNtk, Abc_Obj_t * pNode, char * pNodeName, Vec_Ptr_t * vCone, Vec_Ptr_t * vSupp );
...
extern ABC_DLL Abc_Obj_t *        Abc_NtkFindConst( Abc_Ntk_t * pNtk, char * pName );
...
extern ABC_DLL void               Abc_NodeMffcConeSuppId( Abc_Obj_t * pNode, Vec_Int_t * vConeId, Vec_Int_t * vSuppId );
extern ABC_DLL int                Abc_NodeDeref_rec( Abc_Obj_t * pNode );
extern ABC_DLL int                Abc_NodeDerefKToZero_rec(Abc_Obj_t *pNode, int K);
...
extern ABC_DLL int                Abc_NtkAppend1( Abc_Ntk_t * pNtk1, Abc_Ntk_t * pNtk2, int fAddPos );
extern ABC_DLL Abc_Ntk_t *        Abc_NtkTopmost( Abc_Ntk_t * pNtk, int nLevels );
extern ABC_DLL Abc_Ntk_t *        Abc_NtkSuppCut( Abc_Ntk_t * pNtk, int nLevels );
//extern ABC_DLL Abc_Ntk_t *        Abc_NtkTopmost_sup( Abc_Ntk_t * pNtk, Abc_Obj_t * pNode, char * pNodeName, int nLevels );
/*=== abcSweep.c ==========================================================*/
